    ...
    public function _import($tag,$content,$isFile=false,$type='') {
        ...
        if($isFile) {
            ...
            foreach ($array as $val){
                ...
                switch($type) {
                case 'js':
                    $parseStr .= '<script type="text/javascript" src="../../../../../ThinkPHP/Library/Think/Template/TagLib/'.$val.'"></script>';
                    break;
                case 'css':
                    $parseStr .= '<link rel="stylesheet" type="text/css" href="../../../../../ThinkPHP/Library/Think/Template/TagLib/'.$val.'" />';
                    break;
                case 'php':
